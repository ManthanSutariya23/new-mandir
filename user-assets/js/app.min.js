...
!(function (e, t) {
      ...
      return (
        ...
        (r._setActiveIndicatorElement = function (e) {
          if (this._indicatorsElement) {
            for (
              var t = $.find(".active", this._indicatorsElement), i = 0;
              i < t.length;
              i++
            )
  ...
  H.on(
    ...
    H.on(window, "load.bs.carousel.data-api", function () {
      for (
        var e = $.find('[data-bs-ride="carousel"]'), t = 0, i = e.length;
        t < i;
        t++
      )
  ...
  var K = "collapse",
    ...
    ee = (function (e) {
      function s(t, i) {
        ...
        for (
          var s = $.find('[data-bs-toggle="collapse"]'), r = 0, o = s.length;
          r < o;
          r++
        ) {
          var a = s[r],
      ...
      return (
        ...
        (r.show = function () {
          ...
          if (
            ...
            this._parent &&
              0 ===
                (t = $.find(".show, .collapsing", this._parent).filter(
                  function (t) {
                ...
                if (
                  ...
                  !(
                    (e &&
                      ...
                      c.contains(e.target)) ||
                    H.trigger(r, "hide.bs.dropdown", a).defaultPrevented
                  )
                )
                  "ontouchstart" in document.documentElement &&
                    (l = []).concat
  ...
  function z(e) {
    ...
    for (
      ...
      void 0 !== c[e + t]
        ...
        : h >= c[e] && ((m = e), (g = c[c.length - 1] - c[c.length - 2]));
    }
    let v = null,
      y = null;
    s.rewind &&
    ...
    function (e) {
      ...
      function _(e) {
        ...
        if (((a = !1), (c = !1), p.push(e), !(p.length < 2))) {
          if (((a = !0), (f.scaleStart = w()), !f.slideEl)) {
            ...
            f.maxRatio =
              f.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio;
          }
          if (f.imageEl) {
            const [e, t] = (function () {
      ...
      function M(e) {
        ...
        1 === d && I && ((s = void 0), (r = void 0)),
          (i.scale =
            I || f.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio),
          (d =
            I || f.imageWrapEl.getAttribute("data-swiper-zoom") || n.maxRatio),
          !e || (1 === d && I)
            ? ((p = 0), (v = 0))
      ...
      function L() {
        ...
        if (!f.slideEl) {
          t.params.virtual && t.params.virtual.enabled && t.virtual
            ? (f.slideEl = h(t.slidesEl, "." + t.params.slideActiveClass)[0])
            : (f.slideEl = t.slides[t.activeIndex]);
      ...
      const d = () => {
        ...
        u = () => {
          ...
          c.history.replaceState
            ? (c.history.replaceState(null, null, "#" + i || ""), s("hashSet"))
      ...
      a("init", () => {
        ...
        (r.grid = {
          ...
          updateSlide: (e, s, o, a) => {
            ...
            (s.row = m),
              (s.column = h),
              (s.style[a("margin-top")] = 0 !== m ? d && d + "px" : "");
          },
          ...
          d.shadow &&
            (u
              ? ((f = t.wrapperEl.querySelector(".swiper-cube-shadow")),
                f ||
                  ((f = m("div", "swiper-cube-shadow")), t.wrapperEl.append(f)),
                (f.style.height = r + "px"))
              : ((f = e.querySelector(".swiper-cube-shadow")),
                f || ((f = m("div", "swiper-cube-shadow")), e.append(f))));
          for (let e = 0; e < n.length; e += 1) {
            const t = n[e];
            let i = e;
